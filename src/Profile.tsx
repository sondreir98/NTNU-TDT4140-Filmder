function Profile() {
    return (
        ...
        <div className="flex flex-col gap-5 mt-18 self-start ml-96">
            ...
            <button className="px-8 py-4 bg-green-400 text-white rounded-lg hover:bg-green-600 transition">
                Liked films
            </button>
            {/* biome-ignore lint/a11y/useButtonType: <explanation> */}
            <button className="px-8 py-4 bg-red-400 text-white rounded-lg hover:bg-red-600 transition">
                Disliked films
            </button>
        </div>
    </div>
